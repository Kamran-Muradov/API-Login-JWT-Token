...
namespace Service.Helpers
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<City, CityDto>().ForMember(dest => dest.Country, opt => opt.MapFrom(src => src.Country.Name));
            ...
            CreateMap<Author, AuthorDto>()
                .ForMember(d => d.Books, opt => opt.MapFrom(s => s.BookAuthors.Select(m => new BookDto
                {
                    Id = m.BookId,
                    Title = m.Book.Title
                })));
            ...
            CreateMap<Book,BookDto>()
                .ForMember(d => d.Authors, opt => opt.MapFrom(s => s.BookAuthors.Select(m => new AuthorDto
                {
                    Id = m.AuthorId,
